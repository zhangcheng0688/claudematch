...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    weekly_desc:
      "One curated match. One ready-to-go plan. Delivered every Wednesday at 7pm — like a standing reservation with someone you'll actually want to meet.",
    weekly_days: "days",
    weekly_hrs: "hrs",
    weekly_min: "min",
    weekly_sec: "sec",
  ...
  zh: {
    ...
    weekly_title2: "从不缺席。",
    weekly_desc:
      "一次精心匹配。一份现成方案。每周三晚 7 点准时送达 —— 像一场长期预约，与你真正想见的人。",
    weekly_days: "天",
    weekly_hrs: "时",
    weekly_min: "分",
    weekly_sec: "秒",
  ...
  yue: {
    ...
    weekly_title2: "一次約會。",
    weekly_desc:
      "一個精選配對。一份現成方案。每個禮拜三晚 7 點準時送到 —— 似一場長期預約，同你真正想見嘅人。",
    weekly_days: "日",
    weekly_hrs: "時",
    weekly_min: "分",
    weekly_sec: "秒",
...
export const valuesI18n = {
  ...
  zh: [
    {
      title: "零负担 AI 档案",
      body: "无需填表，无需贴标签。AI 默默从你的行为中理解你真正是谁 —— 而不是你如何描述自己。",
    },
    {
      title: "三大场景，一个平台",
      body: "商业合作、约会、本地伙伴。一个账号覆盖你需要的所有人际连接。",
    },
    {
      title: "AI保驾护航",
      body: "从匹配到见面 —— linQ 为整场约会规划一切。不再有尴尬寒暄，不再放鸽子，只有真实的结果。",
    },
  ],
  yue: [
    {
      title: "零負擔 AI 檔案",
      body: "唔使填表，唔使貼標籤。AI 會默默由你嘅行為入面，知道你真正係邊個 —— 而唔係你點形容自己。",
    },
    {
      title: "三大場景，一個平台",
      body: "商業合作、拍拖、本地朋友。一個帳號已經覆蓋晒你需要嘅所有人際連繫。",
    },
    {
      title: "AI 幫你搞掂約會",
      body: "由配對到見面 —— linQ 幫你成場規劃晒。唔使再尷尬寒暄，唔使再被放飛機，只有真實嘅結果。",
    },
  ],
};
...
export const stepsI18n = {
  ...
  zh: [
    ...
    { n: "03", title: "智能匹配", body: "AI 动态权衡每个场景，为你当下的需求呈现最契合的人。" },
    {
      n: "04",
      title: "AI 规划的见面",
      body: "拿到完整的见面方案 —— 时间、地点、破冰话题。你只管赴约，其余交给 linQ。",
    },
  ],
  yue: [
    {
    ...
    },
    {
      n: "02",
      title: "AI 建立你嘅檔案",
      body: "你嘅行為會被默默分析，幫你整一份多維度嘅真實自我畫像。",
    },
    { n: "03", title: "智能配對", body: "AI 會動態平衡唔同場景，為你當下嘅需要，搵出最夾嘅人。" },
    {
      n: "04",
      title: "由 AI 規劃嘅見面",
      body: "拎到完整嘅見面方案 —— 時間、地點、破冰話題。你負責赴約，其他嘢由 linQ 幫你搞掂。",
    },
  ],
};
...
export const compareRowsI18n = {
  en: [
    ...
    [
      ...
      "Business, dating & local — one unified graph",
    ],
    [
      "Effort to meet",
  ...
  en: [
    {
      tag: "Coffee Chat · SF",
      name: "Leo & Maya",
      quote: "AI nailed our vibe. Two hours flew by.",
    },
    {
      tag: "Rooftop · NYC",
      name: "Jay & Priya",
      quote: "Way better than juggling 10 Hinge chats.",
    },
    {
      tag: "Business · Shanghai",
      name: "Founders Dinner",
      quote: "Met my co-founder on linQ. Closed seed in 6 weeks.",
    },
    {
      tag: "Partnership · London",
      name: "Alex & Jordan",
      quote: "Skipped 20 LinkedIn DMs. Just met. Just clicked.",
    },
    {
      tag: "First Date · Tokyo",
      name: "Mia & Daniel",
      quote: "AI picked the place. We picked each other.",
    },
    {
      tag: "Local Friends · Austin",
      name: "Game Night Crew",
      quote: "Found my Sunday people in one tap.",
    },
  ],
  zh: [
    {
  ...
  yue: [
    {
      tag: "Coffee Chat · 三藩市",
      name: "Leo & Maya",
      quote: "AI 捉到我哋嘅 frequency，兩個鐘轉眼就過。",
    },
    { tag: "天台 · 紐約", name: "Jay & Priya", quote: "好過同時同 10 個人喺 Hinge 傾偈。" },
    {
      tag: "商業 · 上海",
      name: "創辦人晚宴",
      quote: "喺 linQ 識到 Co-founder，6 個禮拜搞掂 seed round。",
    },
