...
export const translations: Record<Lang, Dict> = {
  ...
  zh: {
    ...
    nav_support: "7×24 客服",
    nav_getStarted: "开始使用",
    hero_badge: "Claude 原生匹配平台",
    hero_claude: "Claude 驱动的",
    hero_connections: "连接",
    hero_for: "为了你的",
    hero_work: "事业",
    hero_love: "爱情",
    ...
    send_title1: "把真实的你",
    send_title2: "发送给对方。",
    send_desc: "不需要精心包装的简介,不需要滤镜照片。Claude 会把你最真实的信号 —— 你的思考方式、关心的事、真实状态 —— 打包传递给另一边的人。",
    ...
    footer_bubble: "一位由 Claude 驱动的朋友,直接把现成的匹配推送给你。",
    footer_tag: "面向商业、约会与本地生活的 Claude 原生匹配平台。",
    footer_product: "产品",
    footer_resources: "资源",
    footer_support: "支持",
    footer_careers: "招聘",
