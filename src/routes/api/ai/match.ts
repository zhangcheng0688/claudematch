    ...
    handlers: {
      ...
      POST: async ({ request }) => {
        ...
        if (candidates.length === 0) {
          ...
          // (The user_persona_matches table is new; cast via any until Supabase
          // types are regenerated by Lovable.)
          ...
          // Build the query for active personas in the user's city & scenario.
          ...
          // Pull 5 personas with a spread-friendly ordering:
          // priority first, then least-recently-matched, then least-matched.
